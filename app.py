...
# Charger la liste des équipes depuis un fichier CSV
@st.cache_data
def load_teams():
    try:
...
# Créer deux colonnes pour la sélection des équipes
...
# Vérifier que deux équipes différentes ont été sélectionnées
if equipe1 == equipe2:
    ...
    if submit_form:
        # Créer un résumé des données saisies
        data_summary = {
        ...
        # Appel à la fonction de prédiction (à implémenter)
